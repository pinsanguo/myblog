...
@section('head')
    ...
    <link href="{{asset('resources/views/Home/css/learn.css')}}" rel="stylesheet">
    <!--[if lt IE 9]>
...
<article class="blogs">
    ...
    <div class="newblog left">
        ...
        <figure><img src="{{asset('resources/views/Home/images/01.jpg')}}"></figure>
        <ul class="nlist">
        ...
        <p class="dateview"><span>发布时间：2013-11-04</span><span>作者：杨青</span><span>分类：[<a href="/news/life/">个人博客模板</a>]</span></p>
        <figure><img src="{{asset('resources/views/Home/images/02.jpg')}}"></figure>
        <ul class="nlist">
